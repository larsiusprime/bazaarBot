...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("doran_and_parberry", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("doran_and_parberry", null, 800, 600);
		#end
		#else
		create (null);
		#end
		...
		var projectName = "doran_and_parberry";
		
		var config = {
			
			build: "73",
			company: "LevelUpLabs",
			file: "doran_and_parberry",
			fps: 30,
			name: "Doran & Parberry's example",
			orientation: "",
			packageName: "com.leveluplabs.example",
			version: "1.0.0",
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: true,
					title: "Doran & Parberry's example",
					vsync: false,
					width: 800,
					x: null,
					y: null
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "73";
		app.meta["company"] = "LevelUpLabs";
		app.meta["file"] = "doran_and_parberry";
		app.meta["name"] = "Doran & Parberry's example";
		app.meta["packageName"] = "com.leveluplabs.example";
