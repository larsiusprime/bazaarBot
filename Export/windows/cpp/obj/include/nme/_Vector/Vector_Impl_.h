...
#define INCLUDED_nme__Vector_Vector_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS2(nme,_Vector,Vector_Impl_)
namespace nme{
namespace _Vector{
...
class HXCPP_CLASS_ATTRIBUTES  Vector_Impl__obj : public hx::Object{
	...
	public:
		...
		static Dynamic fromArray( Dynamic a);
...
#endif /* INCLUDED_nme__Vector_Vector_Impl_ */ 
